...
# yapf: disable
try:
    from mmcv.ops import (ContextBlock, ConvWS2d, GeneralizedAttention,
                          conv_ws_2d)
except ImportError:
    from mmcv.cnn import (ContextBlock, ConvWS2d, conv_ws_2d,
                          GeneralizedAttention)

from mmcv.ops import (Conv2d, ConvTranspose2d, CornerPool, DeformConv,
                      ...
                      build_plugin_layer, deform_conv, deform_roi_pooling,
                      get_compiler_version, get_compiling_cuda_version,
                      modulated_deform_conv, nms, nms_match, point_sample,
